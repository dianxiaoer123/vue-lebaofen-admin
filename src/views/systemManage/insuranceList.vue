  ...
  <div class="app-container">
  	...
  	<el-form :inline="true" :model="searchData">
       ...
       <el-form-item label="简称" prop="shortName">
           <el-input v-model="searchData.shortName" @keyup.enter.native="getPage"></el-input>
      </el-form-item>
    ...
    <el-table-column
     ...
     <template slot-scope="scope"> 
        <el-button 
         size="mini"
        type="primary">
         <router-link :to="'/systemManage/insuranceProductList?id='+scope.row.id"> 
          产品列表
         </router-link>  
        </el-button> 
     ...
     <div style='margin-bottom:20px;'><img src="static/images/logo2.png" alt=""></div>
  	 <el-form label-width="100px" :model="sendForm" :rules="rules" ref="sendForm">
        <el-form-item label="名称" prop='name'>
         ...
         <el-form-item label="简称" prop="shortName">
           <el-input v-model="sendForm.shortName"></el-input>
         </el-form-item>
...
export default{
  ...
  data(){
  	return{ 
          addVisible:false,
  		  deleteVisible:false,
          funcName:'InsuranceList',
          searchData:{
            orderNo:'',name:'',shortName:'',keyWord:''
          },
          rules:{
            name: [{ required: true, message: '请输入名称', trigger: 'change' }],
            shortName: [{ required: true, message: '请输入简称', trigger: 'change' }],
          ...
          saveName:'InsuranceSave',
          delName:'InsuranceDel',
          editName:'InsuranceDetail'
  	}
  },
